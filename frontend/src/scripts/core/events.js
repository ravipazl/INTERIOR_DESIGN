...
export const EVENT_MOVED_DRAG = "EVENT_MOVED_DRAG";
...
export const EVENT_ROTATE_ITEM_SELECTED = "ITEM_ROTATE_SELECTED_EVENT";
export const EVENT_ROTATE_ITEM = "EVENT_ROTATE_ITEM";
...
export const EVENT_WALL_SELECT = "WALL_SELECT_EVENT";
export const EVENT_ROOM_SELECT = "ROOM_SELECT_EVENT";
...
export const EVENT_ITEM_UNSELECTED = "EVENT_ITEM_UNSELECTED";

export const EVENT_CORNER_2D_DRAG_START = "EVENT_CORNER_2D_DRAG_START";

export const EVENT_CORNER_2D_DRAG_END = "EVENT_CORNER_2D_DRAG_END";

export const EVENT_WALL_2D_DRAG_START = "EVENT_WALL_2D_DRAG_START";

export const EVENT_WALL_2D_DRAG_END = "EVENT_WALL_2D_DRAG_END";
export const ACTION_EVENT_2D = "ACTION_EVENT_2D";
export const RESET_EVENT_2D = "RESET_EVENT_2D";

export const EVENT_ITEM_COPIED = "EVENT_ITEM_COPIED";
