...
export class HalfEdge extends EventDispatcher {
    ...
    */
    ...
    setTextureMaps(texturePack) {
        // Clone so this wall side owns its own texture object. The room-wide
        // "apply to all walls" path passes ONE texturePack to every edge; without
        // cloning they'd all share it and a later per-wall colour change (which
        // mutates the object in place) would leak to every wall.
